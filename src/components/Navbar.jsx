      ...
      <div className="mx-auto flex max-w-6xl items-center justify-between">
        ...
        <div className="flex items-center gap-4 relative">
          ...
          {showFilter && (
            ...
            >
              <button className="block w-full text-left p-2 hover:bg-gray-200 dark:hover:bg-gray-700 rounded-md" onClick={() =>{ handleFilter("All")} }> 
                All
              </button>
              <button className="block w-full text-left p-2 hover:bg-gray-200 dark:hover:bg-gray-700 rounded-md" onClick={() =>{ handleFilter("Completed")} }>
                Completed
              </button>
              <button className="block w-full text-left p-2 hover:bg-gray-200 dark:hover:bg-gray-700 rounded-md" onClick={() =>{ handleFilter("Important")} }>
                Important
              </button>
            </div>
          )}
